                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody><tr>
                                    <td class="content-block">
                                        <h2>Electrivity Billing System</h2>
                                        <a>1201 straight st Madison,WI-53705</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td>Unit Amount</td>
                                                            <td class="alignright">${billings.billAmount}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>previous Balance</td>
                                                            <td class="alignright">${billings.previousBalance}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Service tax</td>
