...
public class CustomerDaoTest {
    ...
    void getByIdSuccess()
    {
        ...
        assertEquals("larry king", retriedCustomer.getCustomerName());
    }

    @Test
    void insertSuccessCustomer() {

        Customer newCustomer = new Customer("salman","123 street","Madison","WI","salman","man");
        int id = dao.insert(newCustomer);
        assertNotEquals(0,id);
        Customer insertedCustomer = dao.getById(id);
        assertNotNull(insertedCustomer);
        assertEquals("salman", insertedCustomer.getCustomerName());
    ...
    void updateSuccess() {
        ...
        assertEquals(newName, customerAfterUpdate.getCustomerName());
    }
    @Test
    void deleteSuccess() {
